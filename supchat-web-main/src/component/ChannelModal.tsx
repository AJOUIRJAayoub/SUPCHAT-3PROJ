// supchat-web-main/src/component/ChannelModal.tsx
...
const CreateChannelModal = ({
  ...
  const addUserToInvited = (gotUser: any) => {
    if (!user) {
  ...
  const createChatFunction = async () => {
    ...
    try {
      ...
      toast(e?.data?.message || "Error occurred creating channel");
                ...
                <div key={item._id || index} className="w-full flex flex-row justify-between items-center mt-4">
                  <div className="flex flex-row gap-2 items-center">
                    <div className="rounded-[50px] h-10 w-10 overflow-hidden">
                      <img
                        src={
                          item.profilePicture || "https://i.pravatar.cc/40"
                        }
